...
of a running SophiaTX Debug Node. The Debug Node is a plugin for SophiaTX that allows realtime
...
[Python SophiaTX library](https://github.com/xeroc/python-sophiatxlib).
...
[debug_hardforks.py](https://github.com/sophiatxit/sophiatx/python_scripts/tests/debug_hardforks.py)
...
[debugnode.py](https://github.com/sophiatxit/sophiatx/python_scripts/sophiatxdebugnode/debugnode.py#L212)
...
specify the sophiatxd binary location and a populated data directory. For most configurations
this will be `programs/sophiatxd/sophiatxd` and `witness_node_data_dir` respectively, from the
git root directory for SophiaTX.
