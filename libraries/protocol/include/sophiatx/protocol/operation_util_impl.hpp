...
//
// Place SOPHIATX_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define SOPHIATX_DEFINE_OPERATION_TYPE( OperationType )                       \
namespace fc {                                                             \
                                                                           \
...
{                                                                          \
   op.visit( sophiatx::protocol::operation_validate_visitor() );               \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( sophiatx::protocol::get_required_auth_visitor( active, owner, other ) ); \
}                                                                          \
                                                                           \
} } /* sophiatx::protocol */
