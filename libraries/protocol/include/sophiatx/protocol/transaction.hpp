...
FC_REFLECT( sophiatx::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( sophiatx::protocol::signed_transaction, (sophiatx::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( sophiatx::protocol::annotated_signed_transaction, (sophiatx::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
