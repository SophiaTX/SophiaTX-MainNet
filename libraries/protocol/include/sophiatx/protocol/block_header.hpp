...
FC_REFLECT( sophiatx::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( sophiatx::protocol::signed_block_header, (sophiatx::protocol::block_header), (witness_signature) )
