/*
 * Copyright (c) 2016 SophiaTXit, Inc., and contributors.
 */
#pragma once
...
#define SOPHIATX_START_VESTING_BLOCK             (SOPHIATX_BLOCKS_PER_DAY * 7)
#define SOPHIATX_START_MINER_VOTING_BLOCK        (SOPHIATX_BLOCKS_PER_DAY * 30)
...
#define SOPHIATX_VESTING_WITHDRAW_INTERVALS      13
