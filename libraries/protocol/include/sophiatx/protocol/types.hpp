...
#include <sophiatx/protocol/fixed_string.hpp>
...
namespace sophiatx {
   ...
   namespace protocol {
      ...
      typedef fixed_string<24>            account_name_type;
      typedef fixed_string<24>            application_name_type;
...
namespace fc
{
    void to_variant( const sophiatx::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  sophiatx::protocol::public_key_type& vo );
    void to_variant( const sophiatx::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, sophiatx::protocol::extended_public_key_type& vo );
    void to_variant( const sophiatx::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, sophiatx::protocol::extended_private_key_type& vo );
}

FC_REFLECT( sophiatx::protocol::public_key_type, (key_data) )
FC_REFLECT( sophiatx::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( sophiatx::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( sophiatx::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( sophiatx::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( sophiatx::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( sophiatx::protocol::share_type )

FC_REFLECT( sophiatx::void_t, )
