 ...
 * - Length is between (inclusive) SOPHIATX_MIN_ACCOUNT_NAME_LENGTH and SOPHIATX_MAX_ACCOUNT_NAME_LENGTH
 */
...
FC_REFLECT_TYPENAME( sophiatx::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( sophiatx::protocol::authority::key_authority_map)
FC_REFLECT( sophiatx::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( sophiatx::protocol::authority::classification, (owner)(active)(key)(posting) )
