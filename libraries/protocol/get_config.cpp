...
fc::variant_object get_config()
{
   ...
   result["SOPHIATX_CHAIN_ID"] = SOPHIATX_CHAIN_ID;
   result["SOPHIATX_CHAIN_ID_NAME"] = SOPHIATX_CHAIN_ID_NAME;
   ...
   result["SOPHIATX_MAX_WITHDRAW_ROUTES"] = SOPHIATX_MAX_WITHDRAW_ROUTES;
   ...
   result["SOPHIATX_MINING_TIME"] = SOPHIATX_MINING_TIME;
   ...
   result["SOPHIATX_SAVINGS_WITHDRAW_REQUEST_LIMIT"] = SOPHIATX_SAVINGS_WITHDRAW_REQUEST_LIMIT;
   result["SOPHIATX_SAVINGS_WITHDRAW_TIME"] = SOPHIATX_SAVINGS_WITHDRAW_TIME;
