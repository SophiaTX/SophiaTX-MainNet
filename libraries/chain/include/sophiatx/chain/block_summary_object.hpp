...
FC_REFLECT( sophiatx::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( sophiatx::chain::block_summary_object, sophiatx::chain::block_summary_index )
