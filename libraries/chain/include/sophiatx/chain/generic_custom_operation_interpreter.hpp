...
#include <sophiatx/schema/schema.hpp>
   ...
   : public custom_operation_interpreter, public evaluator_registry< CustomOperationType >
{
   public:
      ...
      virtual std::shared_ptr< sophiatx::schema::abstract_schema > get_operation_schema() override
      {
         return sophiatx::schema::get_schema_for_type< CustomOperationType >();
      }
};
