...
namespace sophiatx { namespace chain {
   ...
   using sophiatx::protocol::weight_type;
...
FC_REFLECT_TYPENAME( sophiatx::chain::shared_authority::account_authority_map)
FC_REFLECT( sophiatx::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
