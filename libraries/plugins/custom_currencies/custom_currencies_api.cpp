...
{
   public:
   custom_currencies_api_impl(custom_currencies_plugin& plugin) :
   ...
   custom_currencies_plugin& _plugin;
...
group_meta custom_currencies_api_impl::encode_and_pack(const fc::sha256& key, const fc::sha256& iv, const group_op& op )const
{
...
group_meta custom_currencies_api_impl::encode_and_pack(const fc::sha512& shared_secret, const group_op& op )const
{
   message_wrapper message_content;
   message_content.type = message_wrapper::message_type::group_operation;
   message_content.operation_data = op;
...
string custom_currencies_api_impl::suggest_group_name( const string& description)const
{
...
vector<char> custom_currencies_api_impl::generate_random_key() const
{
...
alexandria_api::api_account_object custom_currencies_api_impl::get_account(const account_name_type& account) const {
...
DEFINE_API_IMPL( custom_currencies_api_impl, get_group)
{
...
DEFINE_API_IMPL( custom_currencies_api_impl, get_group_name)
{
...
DEFINE_API_IMPL( custom_currencies_api_impl, list_my_groups)
{
...
DEFINE_API_IMPL( custom_currencies_api_impl, list_messages)
{
...
DEFINE_API_IMPL( custom_currencies_api_impl, create_group)
{
...
DEFINE_API_IMPL( custom_currencies_api_impl, add_group_participants)
{
...
DEFINE_API_IMPL( custom_currencies_api_impl, delete_group_participants)
{
...
DEFINE_API_IMPL( custom_currencies_api_impl, update_group)
{
...
DEFINE_API_IMPL( custom_currencies_api_impl, disband_group)
{
...
DEFINE_API_IMPL( custom_currencies_api_impl, send_group_message)
{
...
custom_currencies_api::custom_currencies_api(custom_currencies_plugin& plugin): my( new detail::custom_currencies_api_impl(plugin) )
{
   JSON_RPC_REGISTER_API( SOPHIATX_MPM_PLUGIN_NAME, plugin.app() );

}

custom_currencies_api::~custom_currencies_api() {}

void custom_currencies_api::api_startup() {
}

DEFINE_READ_APIS( custom_currencies_api, (get_group) (get_group_name) (list_my_groups) (list_messages)
