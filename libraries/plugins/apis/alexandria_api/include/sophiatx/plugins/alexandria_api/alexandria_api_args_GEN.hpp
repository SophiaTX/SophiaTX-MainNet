...
//   annotated_signed_transaction	transaction;
//};
//
///**
// * gethelp
...
// * get_transaction_id
// */
//// transaction_id_type get_transaction_id(signed_transaction trx){ return trx.id();
...
// * list_witnesses
// */
//// vector<account_name_type> list_witnesses(string lowerbound,uint32_t limit);
...
// * vote_for_witness
// */
//// operation vote_for_witness(string account_to_vote_with,string witness_to_vote_for,bool approve);
...
//   signed_transaction	simple_transaction;
//};
//
///**
// * get_applications
...
//   vector<alexandria_api::api_application_object>	applications_ids;
//};
//
///**
...
//   annotated_signed_transaction	signed_transaction;
//};
//
///**
...
//
//
//DEFINE_API_ARGS( help,			void_type,			help_return);
//DEFINE_API_ARGS( info,			void_type,			info_return);
//DEFINE_API_ARGS( about,			void_type,			about_return);
...
//DEFINE_API_ARGS( get_active_witnesses,			void_type,			get_active_witnesses_return);
...
//DEFINE_API_ARGS( gethelp,			gethelp_args,			gethelp_return);
...
//DEFINE_API_ARGS( get_result_formatters,			void_type,			get_result_formatters_return);
...
//DEFINE_API_ARGS( generate_key_pair,			void_type,			generate_key_pair_return);
...
// * help
// */
//FC_REFLECT( sophiatx::plugins::alexandria_api::help_return,
//			(help) )
//
///**
// * info
...
// * gethelp
// */
//FC_REFLECT( sophiatx::plugins::alexandria_api::gethelp_args,
//			(method) )
//FC_REFLECT( sophiatx::plugins::alexandria_api::gethelp_return,
//			(help) )
//
///**
// * create_account
...
//			(creator)(seed)(json_meta)(owner)(active)(memo) )
...
//			(accountname)(json_meta)(owner)(active)(memo) )
...
//			(witness_name)(url)(block_signing_key)(props) )
...
//			(account_to_vote_with)(witness_to_vote_for)(approve) )
...
//			(callback)(app_id)(account_name)(search_type)(start) )
