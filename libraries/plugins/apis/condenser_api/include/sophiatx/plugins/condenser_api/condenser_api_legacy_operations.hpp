...
void to_variant( const sophiatx::plugins::condenser_api::legacy_operation&, fc::variant& );
void from_variant( const fc::variant&, sophiatx::plugins::condenser_api::legacy_operation& );

}

FC_REFLECT_TYPENAME( sophiatx::plugins::condenser_api::legacy_operation )
