...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             vesting_balance;  /// convert vesting_shares to vesting sophiatx
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      sophiatx_balance( legacy_asset::from_asset( e.sophiatx_balance ) ),
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), sophiatx_revision( s_v ), fc_revision( fc_v ) {}
...
FC_REFLECT( sophiatx::plugins::condenser_api::api_account_object,
...
FC_REFLECT_DERIVED( sophiatx::plugins::condenser_api::extended_account, (sophiatx::plugins::condenser_api::api_account_object),
            (vesting_balance)(transfer_history)(other_history)(witness_votes) )

FC_REFLECT( sophiatx::plugins::condenser_api::extended_dynamic_global_properties,
...
FC_REFLECT( sophiatx::plugins::condenser_api::legacy_chain_properties,
            (account_creation_fee)(maximum_block_size)
          )

FC_REFLECT( sophiatx::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( sophiatx::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( sophiatx::plugins::condenser_api::api_escrow_object,
...
FC_REFLECT( sophiatx::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( sophiatx::plugins::condenser_api::get_version_return,
            (blockchain_version)(sophiatx_revision)(fc_revision) )

FC_REFLECT( sophiatx::plugins::condenser_api::api_application_object,
            (id)
            (name)
            (author)
            (url)
