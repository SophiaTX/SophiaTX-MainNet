...
FC_REFLECT( sophiatx::plugins::debug_node::debug_push_blocks_args,
...
FC_REFLECT( sophiatx::plugins::debug_node::debug_pop_block_return,
            (block) )

FC_REFLECT( sophiatx::plugins::debug_node::debug_set_hardfork_args,
            (hardfork_id) )

FC_REFLECT( sophiatx::plugins::debug_node::debug_has_hardfork_return,
            (has_hardfork) )

FC_REFLECT( sophiatx::plugins::debug_node::debug_get_json_schema_return,
            (schema) )
