...
FC_REFLECT( sophiatx::utilities::console_appender_args, (appender)(stream) )
FC_REFLECT( sophiatx::utilities::file_appender_args, (appender)(file) )
FC_REFLECT( sophiatx::utilities::logger_args, (name)(level)(appender) )
