...
// time.
//
#ifndef SOPHIATX_ACCOUNT_STATISTICS_SPACE_ID
#define SOPHIATX_ACCOUNT_STATISTICS_SPACE_ID 10
#endif

#ifndef SOPHIATX_ACCOUNT_STATISTICS_PLUGIN_NAME
#define SOPHIATX_ACCOUNT_STATISTICS_PLUGIN_NAME "account_stats"
#endif
...
{
   account_stats_bucket_object_type    = ( SOPHIATX_ACCOUNT_STATISTICS_SPACE_ID << 8 ),
   account_activity_bucket_object_type = ( SOPHIATX_ACCOUNT_STATISTICS_SPACE_ID << 8 ) + 1
};
...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_sophiatx_value = 0;     ///< SOPHIATX Value of author rewards
   ...
   share_type           curation_rewards_sophiatx_value = 0;         ///< SOPHIATX Value of curation rewards
   ...
   share_type           liquidity_rewards = 0;                    ///< Amount of SOPHIATX paid as liquidity rewards
   ...
   share_type           sophiatx_sent = 0;                           ///< SOPHIATX sent from this account
   share_type           sophiatx_received = 0;                       ///< SOPHIATX received by this account
   ...
   share_type           sophiatx_vested = 0;                         ///< SOPHIATX vested by the account
   ...
   share_type           sophiatx_received_from_withdrawls = 0;       ///< SOPHIATX received from this account's vesting withdrawals
   share_type           sophiatx_received_from_routes = 0;           ///< SOPHIATX received from another account's vesting withdrawals
   ...
   share_type           sophiatx_converted = 0;                      ///< Amount of SOPHIATX that was converted
   ...
   share_type           limit_order_sophiatx_paid = 0;               ///< SOPHIATX paid by limit orders
   share_type           limit_order_sophiatx_received = 0;           ///< SOPHIATX received from limit orders
...
class account_statistics_plugin : public sophiatx::app::plugin
{
   public:
      account_statistics_plugin( application* app );
      virtual ~account_statistics_plugin();

      virtual std::string plugin_name()const override { return SOPHIATX_ACCOUNT_STATISTICS_PLUGIN_NAME; }
...
FC_REFLECT( sophiatx::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
   ...
   (vests_withdrawn)
   (sophiatx_received_from_withdrawls)
   (sophiatx_received_from_routes)
   ...
   (limit_order_sophiatx_paid)
   (limit_order_sophiatx_received)
   (limit_order_sbd_paid)
   (limit_order_sbd_received)
   (total_pow)
   (estimated_hashpower)
)
//SET_INDEX_TYPE( sophiatx::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   sophiatx::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
