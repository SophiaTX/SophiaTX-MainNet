...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( sophiatx::app::application& app )
            :_app( app ) {}
   ...
   statistics blockchain_statistics_api_impl::get_stats_for_interval( fc::time_point_sec start, fc::time_point_sec end )const
   {
      ...
      const auto& sizes = _app.get_plugin< blockchain_statistics_plugin >( SOPHIATX_BLOCKCHAIN_STATISTICS_PLUGIN_NAME )->get_tracked_buckets();
...
blockchain_statistics_api::blockchain_statistics_api( const sophiatx::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->sophiatx_transferred                      += b.sophiatx_transferred;
   ...
   this->sophiatx_vested                           += b.sophiatx_vested;
   ...
   this->sophiatx_converted                        += b.sophiatx_converted;
