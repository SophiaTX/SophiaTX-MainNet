...
// time.
//
#ifndef SOPHIATX_BLOCKCHAIN_STATISTICS_SPACE_ID
#define SOPHIATX_BLOCKCHAIN_STATISTICS_SPACE_ID 9
#endif

#ifndef SOPHIATX_BLOCKCHAIN_STATISTICS_PLUGIN_NAME
#define SOPHIATX_BLOCKCHAIN_STATISTICS_PLUGIN_NAME "chain_stats"
#endif

namespace sophiatx { namespace blockchain_statistics {
...
{
   bucket_object_type = ( SOPHIATX_BLOCKCHAIN_STATISTICS_SPACE_ID << 8 )
};
...
class blockchain_statistics_plugin : public sophiatx::app::plugin
{
   public:
      blockchain_statistics_plugin( application* app );
      virtual ~blockchain_statistics_plugin();

      virtual std::string plugin_name()const override { return SOPHIATX_BLOCKCHAIN_STATISTICS_PLUGIN_NAME; }
...
struct bucket_object : public object< bucket_object_type, bucket_object >
{
   ...
   share_type           sophiatx_transferred = 0;                       ///< SOPHIATX transferred from account to account
   ...
   share_type           liquidity_rewards_paid = 0;                  ///< Ammount of SOPHIATX paid to market makers
   uint32_t             transfers_to_vesting = 0;                    ///< Transfers of SOPHIATX into VESTS
   share_type           sophiatx_vested = 0;                            ///< Ammount of SOPHIATX vested
   ...
   share_type           vests_withdrawn = 0;                         ///< Ammount of VESTS withdrawn to SOPHIATX
...
} } // sophiatx::blockchain_statistics

FC_REFLECT( sophiatx::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( sophiatx::blockchain_statistics::bucket_object, sophiatx::blockchain_statistics::bucket_index )
