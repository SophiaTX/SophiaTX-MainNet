...
#include <sophiatx/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const sophiatx::app::api_context& ctx );
...
FC_REFLECT( sophiatx::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( sophiatx::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
