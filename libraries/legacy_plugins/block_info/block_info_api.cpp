...
#include <sophiatx/plugins/block_info/block_info_api.hpp>
#include <sophiatx/plugins/block_info/block_info_plugin.hpp>

namespace sophiatx { namespace plugin { namespace block_info {
...
{
   public:
      block_info_api_impl( sophiatx::app::application& _app );

      std::shared_ptr< sophiatx::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( sophiatx::app::application& _app ) : app( _app )
{}

std::shared_ptr< sophiatx::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const sophiatx::app::api_context& ctx )
{
