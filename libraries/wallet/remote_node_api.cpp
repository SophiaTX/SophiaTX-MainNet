...
map< uint64_t, condenser_api::api_received_object >  remote_node_api::get_received(uint32_t app_id, string account_name, string search_type, string start, uint32_t count){
   FC_ASSERT( false);
};
