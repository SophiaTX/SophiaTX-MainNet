...
struct remote_node_api
{
   ...
   alexandria_api::get_accounts_return get_accounts(alexandria_api::get_accounts_args);
   ...
   alexandria_api::get_owner_history_return get_owner_history( alexandria_api::get_owner_history_args );
   ...
   alexandria_api::get_witness_return get_witness(alexandria_api::get_witness_args);
   ...
   alexandria_api::get_account_history_return get_account_history( alexandria_api::get_account_history_args );
   ...
   alexandria_api::get_received_documents_return get_received_documents( alexandria_api::get_received_documents_args );
