...
BOOST_AUTO_TEST_CASE( mh_test )
{
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->non_sophiatx.high == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.low == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.open == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.close == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.volume == ASSET( "0.750 TBD" ).amount );
      ...
      BOOST_REQUIRE( bucket->non_sophiatx.high == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.low == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.open == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.close == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.volume == ASSET( "0.250 TBD" ).amount );
      ...
      BOOST_REQUIRE( bucket->non_sophiatx.open == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.close == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.volume == ASSET( "0.500 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->non_sophiatx.open == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.close == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_sophiatx.volume == ASSET( "1.500 TBD" ).amount );
      bucket++;
