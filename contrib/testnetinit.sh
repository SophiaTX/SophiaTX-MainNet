...
SOPHIATXD="/usr/local/sophiatxd-testnet/bin/sophiatxd"

UTILS="/usr/local/sophiatxd-testnet/bin"
...
cp /etc/sophiatxd/testnet.config.ini $HOME/config.ini
cp /etc/sophiatxd/fastgen.config.ini $HOME/testnet_datadir/config.ini

chown sophiatxd:sophiatxd $HOME/config.ini
chown sophiatxd:sophiatxd $HOME/testnet_datadir/config.ini
...
# setup tinman
git clone https://github.com/sophiatxit/tinman
cd tinman/tinman
git clone https://github.com/sophiatxit/simple_sophiatx_client
cd $HOME
...
echo sophiatxd-testnet: starting fastgen node
...
echo sophiatxd-testnet: pipelining transactions into fastgen node, this may take some time
( \
...
# let's get going
echo sophiatxd-testnet: bringing up witness / full node
